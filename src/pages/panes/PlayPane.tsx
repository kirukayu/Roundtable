...
export default function PlayPane({
  ...
  return (
    <div className="col rev">
      ...
      {/* The overlay is worth knowing about before the game starts. Until now
          the only place it said so was inside itself, which you can only read
          once you have already found it. */}
      <Card title="While you play">
        <div className="note">
          <Icon.Info size={15} />
          <div>
            <div className="note__t">Shift F1 opens the overlay</div>
            <div className="note__b">
              A column down one side of the game: ask about anything and it answers
              from the wikis and from your own save, and the upscaler and frame
              generation are there too. It needs the game in borderless — nothing
              draws over exclusive fullscreen.
            </div>
          </div>
        </div>
      </Card>
